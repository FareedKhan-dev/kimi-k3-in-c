 ...
 * the auto budget MUST use the same number: auto sized itself to 98% while the check
 * refused anything above 95%, so auto could not start on any machine with more than
 * about 67 GB available -- the 3% gap outgrew auto's flat 2 GB margin. */
